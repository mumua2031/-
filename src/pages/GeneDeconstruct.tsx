...
function getPatternImageByCode(heCode: string, fallback: string) {
  return mockPatterns.find((pattern) => pattern.heCode === heCode)?.imageUrl || fallback;
}
...
const symbolShowcaseCards: ShowcaseCard[] = [
  ...
  { titleZh: '\u5668\u7269\u7eb9', titleEn: 'Object Motifs', textZh: '\u4ee5\u74f6\u3001\u76d8\u3001\u5982\u610f\u7b49\u5668\u7269\u4e3a\u7eb9\u6837\u7ebf\u7d22\uff0c\u627f\u8f7d\u5e73\u5b89\u3001\u5706\u6ee1\u4e0e\u793c\u4fd7\u79e9\u5e8f\u3002', textEn: 'Vases, plates and ritual objects carry meanings of peace, completeness and ceremony.', imageUrl: getPatternImageByCode('HE-H-L-M11', '/patterns-transparent/HE-H-L-M11.png') },
  { titleZh: '\u590d\u5408\u7eb9', titleEn: 'Composite Motifs', textZh: '\u51e0\u4f55\u9aa8\u67b6\u3001\u4eba\u7269\u3001\u9f99\u51e4\u4e0e\u745e\u517d\u5143\u7d20\u5171\u6784\uff0c\u5f62\u6210\u591a\u5c42\u7ea7\u7684\u6c49\u7ee3\u7eb9\u6837\u53d9\u4e8b\u3002', textEn: 'Geometric structures, figures, dragon-phoenix forms and auspicious animals form layered Han embroidery narratives.', imageUrl: getPatternImageByCode('HE-H-S-M01', '/patterns/HE-H-S-M01.png') },
];
