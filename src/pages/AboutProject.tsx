...
const legalSections: AboutSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '平台对第三方资料进行收集、分类、摘录、标注或数字化展示，不代表相关著作权、所有权或其他知识产权已经转让给“绣艺境”或邹牧希（英文名简称：Zoey），也不代表访问者获得对相关资料进行复制、下载、传播、改编或商业使用的许可。',
  ...
  },
  {
    ...
    title: '项目原创成果',
    paragraphs: [
      '在不影响第三方合法权利的前提下，下列由邹牧希（英文名简称：Zoey）独立完成并具有原创性的内容，其相关知识产权依法归邹牧希（英文名简称：Zoey）所有：',
    ],
    items: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '访问、浏览或在平台允许范围内查看相关内容，不代表“绣艺境”、邹牧希（英文名简称：Zoey）或任何第三方权利人向使用者转让著作权、商标权、数据库相关权利或其他知识产权，也不构成任何明示或默示的商业许可。',
    ...
    items: [
      ...
      '以任何方式暗示已经获得本项目、邹牧希（英文名简称：Zoey）、博物馆、文化机构或其他第三方的授权、合作、推荐或背书。',
    ],
  },
  {
    number: '八',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '在不违反法律法规强制性规定、不排除使用者依法享有的合理使用、法定许可、公共领域使用及其他法定权利的前提下，邹牧希（英文名简称：Zoey）对本项目原创说明、数据库编排、HE编码解释、页面呈现和资料更新规则保留解释、修订与更新权。',
        ...
        {section.title === '项目原创成果' && (
          <div className="mt-8 border-l border-fuchsia-300/40 pl-5">
            ...
            <p className="mt-4 text-white/78">
              本平台原创内容及具有独创性的选择、编排与视觉表达，其相关权利归邹牧希（英文名简称：Zoey）所有；第三方资料及既有作品的相关权利归原作者或原权利人所有。
            </p>
            <p className="mt-4 text-sm text-fuchsia-100/80">© 2026 邹牧希（英文名简称：Zoey）. All Rights Reserved.</p>
          </div>
        )}
