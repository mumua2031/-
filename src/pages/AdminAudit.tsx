...
const eraSuggestions: EraSuggestion[] = [
  ['HE-N-B-B03', '丹凤牡丹圆框汉绣', '当代复原', '当代'],
  ['HE-N-B-M12', '鸳鸯荷花繁花汉绣', '当代复原', '当代'],
  ['HE-N-B-B09', '黑底五福捧寿圆团花绣', '当代复原（参考清代）', '当代（参考清代）'],
  ['HE-N-B-R03', '凤栖牡丹橙底汉绣', '当代复原', '当代'],
  ['HE-N-S-M01', '凤鸣楚天群凤横向壁挂汉绣', '当代复原（参考战国）', '当代（参考战国）'],
  ['HE-N-L-R02', '半开粉荷白底汉绣', '当代复原', '当代'],
  ['HE-N-B-R01', '双狮戏绣球圆框汉绣', '当代复原', '当代'],
  ['HE-N-B-B01', '双龙捧寿银线汉绣', '当代复原（参考明清）', '当代（参考明清）'],
  ['HE-N-B-M05', '松鹤延年圆形框装汉绣', '当代复原', '当代'],
  ['HE-H-L-M10', '楚式对称凤鹿复古白地汉绣', '当代复原（参考战国）', '当代（参考战国）'],
  ['HE-N-B-G14', '橄榄绿底双鹤朝日圆台屏绣芯', '当代复原', '当代'],
  ['HE-N-B-G13', '湖绿底国色天香牡丹蝴蝶方形绣片', '当代复原', '当代'],
  ['HE-H-B-M02', '湘莲闹三棒鼓舞民俗人物汉绣', '当代复原', '当代'],
  ['HE-N-B-M06', '浅灰底牡丹八宝吉祥纹衣饰汉绣', '当代复原（参考民国）', '当代（参考民国）'],
  ['HE-N-L-R01', '白地粉荷蜜蜂小品汉绣', '当代复原', '当代'],
  ['HE-N-B-M02', '紫花对条浅白底戏服汉绣', '当代复原', '当代'],
  ['HE-N-B-R21', '红底金线青绿五爪龙圆团绣片', '当代复原', '当代'],
  ['HE-N-B-M22', '荷塘双鹤汉绣', '当代复原', '当代'],
  ['HE-N-B-B12', '蓝底金凤牡丹展陈汉绣', '当代复原', '当代'],
  ['HE-N-B-M13', '蓝白牡丹对称黑底绣片', '当代复原', '当代'],
  ['HE-H-B-R03', '红底蝶仙游鱼神话装饰汉绣', '当代复原', '当代'],
  ['HE-H-S-R01', '红底西十七座降龙尊者人物汉绣', '当代复原', '当代'],
  ['HE-N-B-R06', '银杏双喜鹊粉底黑檀圆台屏', '当代复原', '当代'],
  ['HE-N-B-R05', '锦鸡牡丹红底汉剧服饰绣片', '当代复原', '当代'],
  ['HE-N-B-B02', '青蓝蝶恋花绣球汉绣', '当代复原', '当代'],
  ['HE-N-B-M04', '浅白底鸳鸯荷花繁花方形绣片', '当代复原', '当代'],
  ['HE-H-B-M01', '麒麟送子圆补汉绣', '当代复原（参考明清）', '当代（参考明清）'],
  ['HE-H-B-R02', '红底麻姑献寿人物祝寿汉绣', '当代复原', '当代'],
  ['HE-H-S-B15', '黑底满铺楚凤云水横向大型壁挂汉绣', '当代复原（参考战国）', '当代（参考战国）'],
  ['HE-G-B-A02', '戏曲戏服万字锦兽面装饰汉绣', '近现代戏曲戏衣专用绣片', '近现代'],
  ['HE-G-B-A03', '戏曲戏服芦席格花卉几何汉绣', '近现代戏曲戏衣绣片', '近现代'],
  ['HE-G-B-M01', '戏曲《立水江崖》几何海水江崖汉绣局部', '近现代戏曲戏衣汉绣', '近现代'],
  ['HE-H-B-M15', '民间母子多子图人物汉绣纹样', '清代民间婚嫁绣片', '清代'],
  ['HE-H-B-R16', '《福禄图》禄星开脸人物汉绣局部', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-B-A02', '盘金彩绣凤凰纹汉绣', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-B-B05', '青蓝单色菊花汉绣纹样', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-L-G01', '绿彩青蛙水草汉绣纹样', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-B-M10', '蓝底佛手石榴三多纹汉绣', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-B-M11', '紫底多色秋菊汉绣纹样', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-L-M12', '紫彩蝴蝶牵牛花汉绣纹样', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-B-R07', '汉绣红底双凤戏珠戏曲女靠局部绣品', '近现代戏曲戏衣专用汉绣', '近现代'],
  ['HE-N-B-R09', '红梅花枝汉绣纹样', '当代采集，具体年代待考', '具体年代待考'],
  ['HE-N-B-R10', '红彩成对金鱼汉绣纹样', '当代采集，具体年代待考', '具体年代待考'],
