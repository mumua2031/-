...
const symbolismByCode = {
  'HE-N-B-M12': '九头鸟又称九凤，是战国时期楚国先祖崇拜的神鸟；本件以九首凤鸟表现楚地神鸟与祥瑞意象。',
  'HE-N-B-M01': '狮子与绣球组合构成喜庆祈福题材，归吉祥祈福类。',
  'HE-N-B-B10': '牡丹在汉绣纹样中使用频繁，象征富贵；本件以三色牡丹构成富贵主题。',
  'HE-N-B-B03': '凤凰象征祥瑞与和谐，牡丹象征富贵；二者组合寓意荣华富贵。',
  'HE-H-S-M12': '莲花象征纯洁高雅；鸳鸯与荷花组合构成和合、美满主题。',
  'HE-N-B-B09': '蝙蝠因蝠与福谐音，常作为吉祥物；五福为长寿、富贵、康宁、好德、善终，寿字共同构成福寿主题。',
  'HE-H-S-B08': '以武汉城市地标、江豚吉祥物与民俗图景构成当代城市纪念题材，归人文民俗纹样。',
  'HE-N-B-R03': '凤凰象征祥瑞与和谐，牡丹象征富贵；凤栖牡丹题材寓意荣华富贵。',
  'HE-N-S-M01': '凤凰是中国传统文化中的祥瑞元素；楚凤题材承载荆楚地域文化记忆。',
  'HE-N-L-R02': '莲花象征纯洁高雅；本件以半开粉荷表现清雅花卉小品。',
  'HE-N-B-R01': '狮子与绣球组合构成喜庆祈福题材，归吉祥祈福类。',
  'HE-N-B-B01': '龙在传统纹样中为神物，可用于祥瑞喜庆语境；双龙、祥云与寿字组合表达福寿吉祥。',
  'HE-N-S-M04': '鹤象征长寿，凤凰象征祥瑞；古黄鹤楼题材承载武汉地域文化记忆。',
  'HE-H-S-R02': '鹤象征长寿；古黄鹤楼与群鹤组合承载武汉地域文化记忆与福寿祝愿。',
  'HE-N-B-M03': '凤凰象征祥瑞，牡丹象征富贵；鸽子、麦穗在画面中补充安宁与丰收主题。',
  'HE-H-S-A02': '黄鹤楼与山水构成武汉地域文化题材；金线表现与盘金绣的金色轮廓质感相近。',
  'HE-N-B-M14': '凤凰象征祥瑞与和谐；本件以凤鸟羽翼和花纹表现吉祥主题。',
  'HE-N-B-B04': '龙在传统纹样中为神物，常与祥瑞、喜庆丰收相连；本件以金龙、旭日与祥云构成祥瑞主题。',
  'HE-N-B-M05': '松树象征长寿，鹤也是长寿事物的象征；松鹤组合对应祝寿祈福主题。',
  'HE-N-S-A01': '凤凰是中国传统文化中的祥瑞元素；楚凤江城题材承载荆楚地域文化记忆。',
  'HE-H-L-M10': '凤凰象征祥瑞，鹿与禄谐音；凤、鹿与卷草云纹共同构成荆楚复古清赏题材。',
  'HE-N-B-G14': '鹤是长寿事物的象征；双鹤与朝日、海水江崖共同构成祝寿祈福主题。',
  'HE-N-B-M07': '莲花象征纯洁高雅；荷塘花鸟与儿童围兜形制共同构成平安护佑和自然生趣主题。',
  'HE-N-B-G13': '牡丹象征富贵，蝴蝶象征爱情、婚姻幸福与美满；二者组合表达富贵与美满。',
  'HE-N-B-B11': '牡丹在汉绣纹样中使用频繁，象征富贵；本件以描金牡丹表现富贵主题。',
  'HE-H-B-M02': '人物图案常取材于历史典故、戏曲故事和日常生活；本件记录湖北民间三棒鼓表演与莲荷场景。',
  'HE-N-B-M06': '牡丹象征富贵；与佛教八宝纹样组合，构成富贵吉祥主题。',
  'HE-N-L-A13': '凤凰象征祥瑞与和谐；盘金绣使用金线并置固定，用于表现外轮廓和金色块面质感。',
  'HE-N-B-R02': '福字寓意幸福和福气；蝙蝠因蝠与福谐音，与花卉共同构成纳福主题。',
  'HE-N-B-B05': '桃子象征长寿，蝙蝠取福气，蝴蝶象征美满；组合表达福寿与美好。',
  'HE-N-L-B01': '莲花象征纯洁高雅；蜜蜂作为自然生趣点缀，归生活志趣类。',
  'HE-N-B-M02': '对称花卉纹样作为服饰装饰，表达花卉吉祥与规整秩序。',
  'HE-N-B-B08': '龙在传统纹样中为神物，常与祥瑞、喜庆丰收相连；本件以龙与珠构成祥瑞主题。',
  'HE-N-B-R04': '松鼠与葡萄藤蔓组合表达丰收、多子与延绵，归吉祥祈福类。',
  'HE-H-B-R09': '龙在传统纹样中可表示身份与祥瑞；五爪团龙配合红底和卷草，构成庄重吉祥主题。',
  'HE-H-S-R08': '凤凰象征祥瑞；黄鹤楼与楚纹承载武汉地域文化记忆和荆楚文化象征。',
  'HE-N-B-B07': '鹤是长寿事物的象征；八鹤祥云组合构成祝寿祈福主题。',
  'HE-N-L-M08': '竹可与松兰组成坚韧、友情长久的植物意象；本件以翠竹和绶带鸟表现清雅生趣。',
  'HE-N-B-R07': '牡丹象征富贵，蝴蝶象征爱情、婚姻幸福与美满；二者组合表达富贵与美满。',
  'HE-N-L-M01': '鹤象征长寿，莲花象征纯洁高雅；本件兼具荷塘清雅与祝寿意象。',
  'HE-N-S-B04': '凤凰象征祥瑞，牡丹象征富贵；金凤牡丹组合构成祥瑞富贵主题。',
  'HE-N-B-M13': '牡丹象征富贵；左右对称构图强化成双与规整的装饰秩序。',
  'HE-N-B-B06': '蝴蝶象征爱情、婚姻幸福与美满；百花与蝴蝶共同构成美好花卉主题。',
  'HE-H-B-R03': '蝴蝶象征爱情、婚姻幸福与美满；鱼类纹样寓意吉祥富贵，本件归人文民俗叙事。',
  'HE-N-B-M09': '牡丹象征富贵，蝴蝶象征爱情、婚姻幸福与美满；二者组合表达富贵与美满。',
  'HE-H-S-R01': '佛教人物是汉绣人物图案的重要题材；龙为传统神物，本件以降龙尊者承载宗教人物叙事。',
  'HE-H-S-A03': '鹤象征长寿；黄鹤楼与云鹤组合承载武汉地域文化记忆与福寿祝愿，金线表现突出盘金质感。',
  'HE-N-B-R06': '喜鹊在传统图案中寓意喜事上门；本件与银杏花叶组合构成吉庆主题。',
  'HE-N-B-M08': '鱼类纹样寓意吉祥富贵，鲤鱼还有跃龙门之意；本件以锦鲤和银杏构成富足吉祥主题。',
  'HE-N-B-R05': '牡丹象征富贵；花鸟题材常用于服饰装饰，本件以锦鸡和牡丹表现富贵主题。',
  'HE-N-B-M15': '凤凰象征祥瑞，鹿与禄谐音；凤、鹿与卷草云纹共同构成荆楚复古清赏题材。',
  'HE-N-B-B02': '蝴蝶象征爱情、婚姻幸福与美满；绣球与花叶共同构成圆满美好主题。',
  'HE-H-L-M11': '博古图寓意文采高雅、通晓古今、趋吉避凶与富贵吉祥；本件以青铜花觚构成仿古清赏题材。',
  'HE-N-B-M04': '莲花象征纯洁高雅；鸳鸯与荷花组合构成夫妻和合、婚姻美满主题。',
  'HE-H-B-M01': '麒麟是古代神兽，被认为有瑞祥之气，并有驱邪祈福、镇宅之意；本件题名为麒麟送子，归吉祥祈福类。',
  'HE-H-B-R02': '麻姑是古代长寿仙女；麻姑献寿题材表达长寿祝愿。',
  'HE-H-S-B15': '凤凰是中国传统文化中的祥瑞元素；楚凤云水题材承载荆楚地域文化记忆。',
  'HE-H-L-A14': '虎、鹿、松等可组成福禄寿意象；本件以楚式白虎图腾和盘金工艺表现守护主题。',
  'HE-H-B-A12': '龙在传统纹样中可表示身份与祥瑞；正龙配海水江崖构成庄重吉祥主题。',
  'HE-N-B-R08': '龙凤组合象征婚姻幸福美满、阴阳调和；宝珠补充圆满吉祥意象。',
};
