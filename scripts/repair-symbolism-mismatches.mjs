...
const repairs = {
  'HE-NB-M01': '狮子与绣球组合常用于表达纳福、喜庆与圆满。',
  'HE-HS-M12': '鸳鸯与荷花组合常用于表达和合、美满。',
  'HE-NL-R02': '荷花取清雅、高洁意象，归生活志趣类花卉小品。',
  'HE-NB-M03': '金凤、和平鸽、牡丹与麦穗组合，表达祥瑞、安宁与丰收祝愿。',
  'HE-NB-B04': '金龙戏珠与旭日、祥云组合，寓意祥瑞、兴盛与护佑。',
  'HE-HL-M10': '楚凤、楚鹿与卷草云纹组合，体现荆楚审美与复古清赏。',
  'HE-NB-M07': '荷塘花鸟与儿童围兜形制结合，表达平安、护佑与自然生趣。',
  'HE-NB-R04': '松鼠与葡萄藤蔓组合，寓意丰收、多子与延绵。',
  'HE-HS-R08': '黄鹤楼、双凤与楚纹组合，承载江城文脉与荆楚文化象征。',
  'HE-NS-B04': '金凤与牡丹组合，承载祥瑞、富贵与非遗展陈意味。',
  'HE-NB-M08': '锦鲤与银杏组合，寓意顺遂、富足与长久安康。',
  'HE-NL-M08': '翠竹与绶带鸟组合，体现清雅、自然生趣。',
  'HE-NB-B02': '绣球、蝴蝶与花叶组合，寓意圆满、美好。',
  'HE-HL-M11': '青铜花觚与博古纹样组合，体现仿古清赏与生活志趣。',
  'HE-HB-M01': '麒麟送子题材表达添丁、子嗣贤德与吉祥祝愿。',
};
